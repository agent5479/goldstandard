...
export const labels = {
  ...
  householdBookings: 'Website bookings',
  householdBookingsHint: 'Appointments imported from the booking form — dates, times, and locations are kept as booked.',
  noHouseholdBookings: 'No website bookings imported for this household yet.',
