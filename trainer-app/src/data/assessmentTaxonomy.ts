...
export const GUIDE_ANCHORS: GuideAnchor[] = [
  ...
  { id: 'love-at-the-right-time', label: 'Love at the right time', icon: 'bi-heart', groupId: 'leadership' },
  { id: 'trust-not-just-love', label: 'Trust, not just love', icon: 'bi-heart-half', groupId: 'leadership' },
  ...
  { id: 'dog-tantra', label: 'Dog-Tantra (shared flow)', icon: 'bi-broadcast', groupId: 'leadership' },
  ...
  { id: 'rehabilitation-patterns', label: 'Rehabilitation patterns', icon: 'bi-arrow-repeat', groupId: 'understanding' },
  { id: 'behavior-driver-calibration', label: 'Driver calibration', icon: 'bi-signpost-split', groupId: 'understanding' },
  { id: 'pattern-playbook-table', label: 'Pattern playbook', icon: 'bi-journal-medical', groupId: 'understanding' },
  { id: 'symptom-expression-index', label: 'Symptom index', icon: 'bi-list-check', groupId: 'understanding' },
  { id: 'case-compulsive-licking', label: 'Case: handler licking', icon: 'bi-heart', groupId: 'understanding' },
  ...
  { id: 'architecture-of-clarity', label: 'Architecture of clarity', icon: 'bi-balance-scale', groupId: 'training' },
  { id: 'conservation-of-force', label: 'Conservation of force', icon: 'bi-lightning-charge', groupId: 'training' },
  { id: 'correction-praise-trap', label: 'Correction-praise trap', icon: 'bi-arrow-repeat', groupId: 'training' },
  { id: 'expectation-of-excellence', label: 'Expectation of excellence', icon: 'bi-star', groupId: 'training' },
  ...
  { id: 'puppy-nutrition-access', label: 'Nutrition & access', icon: 'bi-cup-straw', groupId: 'puppy-phase' },
  ...
  { id: 'puppy-tracking', label: 'What to track', icon: 'bi-clipboard-check', groupId: 'puppy-phase' },
  { id: 'puppy-household-dynamics', label: 'Household dynamics', icon: 'bi-people', groupId: 'puppy-phase' },
  { id: 'puppy-planner', label: 'Puppy Planner', icon: 'bi-calendar3', groupId: 'puppy-phase' },
