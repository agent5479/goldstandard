...
const ALIASES: { terms: string[]; anchor: string }[] = [
  ...
  { terms: ['gold standard rule', 'gold standard', 'authority', 'sit', 'wait', 'nothing for free', 'consent', 'release', 'you decide', 'permission before action', 'owner dog jobs', 'on the leash'], anchor: 'gold-standard-rule' },
