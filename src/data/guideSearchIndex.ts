...
const ALIASES: { terms: string[]; anchor: string }[] = [
  ...
  { terms: ['pillars', 'three pillars', 'four pillars', 'preparation', 'consistency', 'real world wins', 'drain the tank', 'pack leader', 'pack leader energy', 'anchor energy', 'energy', 'caesar', 'cesar', 'millan', 'dogs dont lie', "dogs don't lie", 'biofeedback'], anchor: 'pillars' },
  { terms: ['gold standard rule', 'gold standard', 'authority', 'sit', 'wait', 'nothing for free', 'consent', 'release', 'you decide', 'permission before action', 'continuous check-in', 'relinquished leadership', 'deferential focus', 'sole decision-maker', 'owner dog jobs', 'on the leash'], anchor: 'gold-standard-rule' },
  ...
  { terms: ['ready stance', 'athletic stance', 'pre-engaged', 'martial arts stance', 'readiness', 'lower core', 'occiput', 'gut anchor', 'peripheral vision'], anchor: 'ready-stance' },
  { terms: ['dog tantra', 'dog-tantra', 'flow state', 'athlete zone', 'the zone', 'shared flow', 'somatic anchor', 'pack feeling', 'embodiment method'], anchor: 'dog-tantra' },
  ...
  { terms: ['needs vocabulary', 'needs tracing', 'pattern tracing', 'canine pattern tracing', 'kinesiology', 'vice vocabulary', 'needs and vices', 'connection needs', 'physical well-being', 'autonomy', 'honesty elucidation', 'meaning needs'], anchor: 'needs-vice-vocabulary' },
  ...
  { terms: ['butt push', 'bark', 'barking', 'yap', 'fixation', 'reactive', 'reactivity', 'were not barking', "we're not barking", 'not growling', 'were not growling', "we're not growling", 'light touch butt', 'reminder command'], anchor: 'butt-push' },
  { terms: ['pulling', 'slack leash', 'heel', 'walking position', 'walk beside', 'behind the back', 'behind-the-back', 'free hand butt push'], anchor: 'leash' },
  { terms: ['blind spot', 'peripheral focus', 'peripheral vision leash', 'forge', 'walking ahead', 'leash focus', 'field of view'], anchor: 'walking-position' },
  { terms: ['choice to leave', 'shoulders past leg', 'spatial boundary', 'forge cue', 'leash accountability'], anchor: 'leash-accountability' },
  { terms: ['whine return', 'whine equals return', 'separation camera', 'demand barking', 'alone vocalising', 'silence gated', 'alone time panic'], anchor: 'pattern-playbook-separation' },
  { terms: ['distress vocalising alone', 'separation whining', 'camera monitoring dog', 'true anxiety vs demand'], anchor: 'symptom-vocal-demand-alone' },
  { terms: ['jumping', 'jumping up', 'walk back to sit', 'walk-back', 'visitor jump', 'unmanaged greeting'], anchor: 'jumping-up' },
  { terms: ['session home gap', 'works with trainer', 'entitled at home', 'different with owner', 'control attempts'], anchor: 'session-home-gap' },
  ...
  { terms: ['puppy phase', 'puppy toilet', 'house training puppy', 'puppy walk-back', 'puppy jumping', 'puppy mouthing', 'puppy schedule'], anchor: 'puppy-phase' },
