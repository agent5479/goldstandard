...
export default function SectionReadingDog() {
  return (
    <section className="guide-section" id="reading-dog">
      ...
      <p className="section-num">07 — Reading behaviour</p>
