export default function SectionExpectations() {
  return (
    <section className="guide-section" id="expectations">
      ...
      <ul className="checklist">
        <li>Expect your dog to be smart — it will rise to that</li>
        <li>Expect it to push boundaries — and it will find them</li>
        <li>Expect it to come back when called — and hold that expectation with calm certainty, not hope</li>
      </ul>

      <div className="mantra">
        <p>"Expect him to come back when you call and he will. If he doesn't — be patiently relentless."</p>
      </div>

      <p>When a dog disobeys and runs off, do not turn the recall into a game. Chasing with tension, excitement, or frustration teaches the dog that bolting gets a fun pursuit. Instead, pursue <em>joylessly</em> and <em>relentlessly</em>, at a casual pace. No drama, no tension the dog can feed on — just the quiet certainty that you will not stop and that running away cannot win.</p>
      ...
      <p>Treats give a clear, repeatable currency for the association window — see <a href="#timing">Timing</a> and <a href="#rewards">Rewards</a>. Affection can follow once the dog is calm at your side; during training, the go-get pattern needs something the dog will reliably work for. Keep sessions short, reset the distance if they blow past you, and build until the recall lands inside the one-second rule without the treat visible every time.</p>
      ...
      <p>The <a href="#leash-jerk">downward leash jerk</a> and slack-line work in <a href="#leash">Leash work</a> help facilitate that shift in dynamic: the dog feels heavier, yields position, and learns the walk is yours. Pair that physical frame with the attitude — relentless consistency of <em>I'm over it</em> — and they will adapt. But understand: relentless is not a game. No chase-as-fun, no back-and-forth banter, no "let's see if I can make you react today." That is exactly what keeps misbehaviour alive — the dog learns that pushing you is engaging, even when you think you are correcting.</p>
