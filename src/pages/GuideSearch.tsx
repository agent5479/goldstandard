...
const ALIASES: { terms: string[]; href: string }[] = [
  ...
  { terms: ['understanding', 'leadership theme', 'training theme'], href: '#guide-theme-understanding' },
  { terms: ['social needs theme', 'part 4 social', 'dog to dog theme'], href: '#guide-theme-social-needs' },
  ...
  { terms: ['trauma vs hardship', 'hardship builds character', 'pampered dog', 'privileged breed', 'too easy life', 'correction scale calibration'], href: '#trauma-vs-hardship' },
  { terms: ['true canine trauma', 'acoustic overload', 'kennel barking puppy', 'cargo shock', 'air freight dog', 'context shock', 'ceiling fan fear', 'hardwood floor panic', 'hit by a man'], href: '#true-canine-trauma' },
  { terms: ['8 week puppy', 'eight week separation', 'litter separation', 'crate isolation first night', 'puppy sleep in bed', 'littermate security'], href: '#eight-week-separation' },
  { terms: ['trauma hardship calibration', 'entitled dog correction', 'intentional hardship', 'counter surfer', 'attention demander'], href: '#trauma-hardship-calibration' },
  { terms: ['pack guarding', 'bathroom follow', 'bathroom dog', 'evolutionary guard', 'elimination guard'], href: '#pack-guarding' },
  { terms: ['rehabilitation', 'substitution', 'substitute dont suppress', 'mouth job', 'chin command', 'nose command', 'compulsive licking', 'licky dog', 'behavioral decoupling', 'proactive guidance'], href: '#rehabilitation-patterns' },
  { terms: ['driver calibration', 'behavior driver', 'skill gap', 'owner dynamics', 'entitlement hardship', 'neuro stress loop', 'distinguish trauma', 'misread trauma'], href: '#behavior-driver-calibration' },
  { terms: ['pattern playbook', 'neuro pattern', 'anxious attachment', 'handler sensitive', 'barrier frustration', 'fixation loop'], href: '#pattern-playbook-table' },
  { terms: ['symptom index', 'self licking', 'handler licking', 'paw chewing', 'repetitive soothing', 'velcro follow', 'compulsive'], href: '#symptom-expression-index' },
  { terms: ['social needs', 'social world', 'dog to dog', 'dog-to-dog'], href: '#social-needs' },
  ...
  { terms: ['intact large male', 'large intact', 'untrained male', 'intact male playbook', '47kg', '47 kg', 'powerful intact', 'testosterone rank', 'intact health', 'musculoskeletal intact', 'testosterone anxious'], href: '#intact-health-baseline' },
  { terms: ['sentinel path', 'containment path', 'socialite path', 'three paths', 'intact mastery', 'desexing path', 'neuter path', 'lifestyle crossroads', 'social penalty intact', 'bow up intact', 'daycare intact', 'boarding intact denied'], href: '#intact-three-paths' },
  { terms: ['intact social penalty', 'neutered hostility intact', 'humping operant resistant', 'marking intact'], href: '#intact-social-penalty' },
  { terms: ['intact daycare', 'intact boarding', 'dog park intact', 'shrunk world intact'], href: '#intact-environment-restrictions' },
  { terms: ['biological drive fairness', 'intact frustration no outlet', 'evolutionary drive denied'], href: '#biological-drive-fairness' },
  { terms: ['vasectomy', 'ovary sparing', 'hormone sparing surgery', 'surgical alternatives intact'], href: '#surgical-alternatives' },
