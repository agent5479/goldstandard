...
export default function BreedDetailContent({ breedName, breedKeys = [] }: BreedDetailContentProps) {
  const breed = resolveBreedForDetail(breedName, breedKeys);
  if (!breed) {
    return <p className="intelligence-breed-detail-note">No temperament profile available for this breed.</p>;
  }
