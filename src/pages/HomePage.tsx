...
export default function HomePage() {
  return (
    <>
      <Seo
        title="Gold Standard Dog Training | Golden Bay, New Zealand"
        description="The dog you always wanted is already in there. Gold Standard Dog Training — Golden Bay, NZ. Effective, structured dog training, rehabilitation and in-person coaching using Beckman's proven technique. Call Warwick: 027 814 2222."
        bodyClass="page-home"
      />
      <SiteHeader />
      ...
      <section className="hero">
        <div className="hero-body">
          ...
          <div className="hero-cta">
            <a href="tel:+64278142222" className="btn btn-primary">Call 027 814 2222</a>
            <a href="#services" className="btn btn-secondary">See what's available</a>
          </div>
        </div>
      ...
      <section className="services" id="services">
        <div className="section-inner">
          ...
          <p className="service-note">💬 Not sure what is right for your dog yet? <Link to="/contact">Send a quick enquiry</Link> and Warwick can guide you to the best starting point.</p>
        </div>
      </section>
      ...
      <section className="contact" id="contact">
        <div className="section-inner">
          ...
          <p>📱 Call or text Warwick to discuss your dog and what you're hoping to achieve. First conversation is always free.</p>
          <p><Link to="/contact" className="btn btn-primary">Send an enquiry</Link></p>
