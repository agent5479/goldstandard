  ...
  return (
    <>
      <Seo
        ...
        description="Meet Warwick Marshall of Gold Standard Dog Training in Golden Bay. Learn the training philosophy, service area, and what to expect from coaching sessions."
      />
      <SiteHeader />
