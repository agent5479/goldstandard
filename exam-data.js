/* ============================================================
   ...
   Derived from guide.html. Edit freely — plain data only.

   Fields:
     topic         — display group used in the results breakdown
     breedCategory — 'all', or one of: clingy, herding, terrier,
                     guardian, small (see breed-data.js)
     track         — 'both' (owner + trainer) or 'trainer' only
     options       — answer choices; the FIRST option is always
                     the correct one (the exam shuffles them)
     explanation   — shown when reviewing a wrong answer
     guideLink     — anchor into guide.html for further reading
   ============================================================ */

const GSDT_QUESTIONS = [
