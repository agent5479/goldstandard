...
const BEACH_EXTRAS_NOTE = "Includes additional people attending, and a helper dog when needed.";
const TOWN_EXTRAS_NOTE = "Includes additional people attending. Helper dogs are not used for town visits.";
